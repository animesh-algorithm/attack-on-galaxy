...
let enemyShipsImages = ['img/pixel_ship_blue_small.png', 'img/pixel_ship_red_small.png', 'img/pixel_ship_green_small.png']
let enemyLasersImages = ['img/pixel_laser_red.png', 'img/pixel_laser_blue.png', 'img/pixel_laser_green.png']
let enemies = []
let playerLasers = []
...
function main() {
    ...
    function createLaser() {
        ...
        playerLaserImg.setAttribute('src', 'img/pixel_laser_yellow.png')
